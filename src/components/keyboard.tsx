...
export function MyKeyboard() {
  ...
  const firstNumberDisplay = () => {
    if (result !== null) {
      return <Text
        style={result < 99999 ? [Styles.screenFirstNumber, {color: Colors.result}] : [Styles.screenFirstNumber, {
          fontSize: 50,
          color: Colors.result
  ...
  return (
    <View style={Styles.viewBottom}>
      ...
      <View style={Styles.row}>
        <MyButton title="C" isGrey onPress={clear}/>
        <MyButton title="+/-" isGrey onPress={() => handleOperationPress("+/-")}/>
        <MyButton title="％" isGrey onPress={() => handleOperationPress("％")}/>
        <MyButton title="÷" isBlue onPress={() => handleOperationPress("/")}/>
      </View>
      <View style={Styles.row}>
      ...
      <View style={Styles.row}>
        <MyButton title="." onPress={() => handleNumberPress(".")}/>
        <MyButton title="0" onPress={() => handleNumberPress("0")}/>
        <MyButton title="⌫" onPress={() => setFirstNumber(firstNumber.slice(0, -1))}/>
        <MyButton title="=" isBlue onPress={() => getResult()}/>
      </View>
    </View>
  );
}